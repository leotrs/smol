...
MATRIX_TYPES: dict[str, MatrixType] = {
    ...
    for m in (
        ...
        MatrixType("distnorm", "Normalized Distance Laplacian", normalized_distance_laplacian, is_complex=False, connected_only=True),
        MatrixType("ecc", "Eccentricity", eccentricity_matrix, is_complex=False, connected_only=True),
