"""
Test if (C1)+(C2)+(C3-tri) is sufficient for NBL-cospectrality.
C3-tri: equal triangle counts through switched edges.
"""
...
def find_c1c2c3_switches(G):
    """Find switches satisfying C1 + C2 + C3-tri."""
    results = []
...
for n in range(4, 9):
    ...
    for g6 in graphs:
        ...
        for v1, w1, v2, w2, Gp in find_c1c2c3_switches(G):
            n_sw += 1
