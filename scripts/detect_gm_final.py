#!/usr/bin/env python3
"""Final corrected GM switching detector - run on all pairs.

Usage:
    python scripts/detect_gm_final.py --n 8
    python scripts/detect_gm_final.py --n 9 --sample 1000
"""
...
def main():
    parser = argparse.ArgumentParser(description="Detect GM switching (corrected algorithm)")
    ...
    if gm_pairs:
        filename = f"adj_n{args.n}_gm_correct.txt"
